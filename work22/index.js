...
window.onload = function(){
    ...
    for(var i = 0, j= radios.length;i<j;i++){
        radios[i].onclick = function(){
           ...
           document.getElementById("Jms_main").style.width  = value*48+180+60+'px';
        }
    }
    init(10,10);
};
...
function init(rowCount,colCount,minLandMineCount,maxLandMineCount){
    ...
    timeShow = doc.getElementById("cosTime"),
    ...
    jms = JMS("landmine",rowCount,colCount,mianLandMinCount,maxLandMineCount);
    ...
    jms.landMineCountBack = function(count){
